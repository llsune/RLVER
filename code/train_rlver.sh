...
WANDB_TOKEN="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"
RUN_NAME="rlver-reproduction-qwen1.5b-ppo-thinking"
IF_THINK=True
DIR_TO_SAVE_CKPTS="/data/yywang/Projects/EvoMem/GitHub/digitalhuman/RLVER/reproduction/qwen1.5b-ppo-thinking/checkpoints"
...
ray job submit --address="http://127.0.0.1:8265" \
   ...
   "YOUR_ENV_VARS"
    ...
    actor_rollout_ref.model.path="/data/yywang/Models/Qwen2.5-7B-Instruct" \
